                    ...
                    <div className="project-details-wrapper">
                        ...
                        <div className="project-details">
                            ...
                            <div className="description-project mb-3">
                                <p className="">The Eclipse Safe Open Vehicle Core project aims to develop an open-source core stack for Software Defined Vehicles (SDVs), specifically targeting embedded high-performance Electronic Control Units .The Eclipse Safe Open Vehicle Core project aims to develop an open-source core stack for Software Defined Vehicles (SDVs), specifically targeting embedded high-performance Electronic Control Units</p>
                            </div>
